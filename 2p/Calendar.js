...
console.log(ejemplo.isLeapYear(1896)); //true
console.log(ejemplo.isLeapYear(1900)); //false
console.log(ejemplo.firstDayYear(2019)); //Martes  2
console.log(ejemplo.todayPlus("Jueves",1));//Viernes  5
console.log(ejemplo.printCalendar(1,2019));
console.log(ejemplo.printCalendar(2,2020));